<?php
			...
			<div id="login-e-cadastro"> <!-- Parte de login e cadastro do site -->
				...
				<div id="login-e-cadastro-texto">
					<?php
						...
						{
							echo "<a href='minha-pagina/compras.php' id='login-e-cadastro-link'>Olá, " . $_SESSION['nome'] . "</a> <br>
							      <a href='../app/logout.php' id='login-e-cadastro-link'>Sair</a>";
						}
						else if(isset($_SESSION['codigo_profissional']))
						{
							echo "<a href='pcontrole/pcontrole.php' id='login-e-cadastro-link'>Olá, " . $_SESSION['nome'] . "</a> <br>
							      <a href='../app/logout.php' id='login-e-cadastro-link'>Sair</a>";
						}
						else
						{
	...
	<section id="conteudo-menu-mobile"> 
		...
		<ul>
			...
			<li><a href="sobre.php" id="menu-link">Sobre</a></li>
			...
			<?php
					...
					{
						echo "<br>";
						echo "<a href='minha-pagina/compras.php' id='login-e-cadastro-link'>Olá, " . $_SESSION['nome'] . "</a> <br><br>
						<a href='../app/logout.php' id='login-e-cadastro-link'>Sair</a>";
					}
					else if(isset($_SESSION['codigo_profissional']))
					{
						echo "<br>";
						echo "<a href='pcontrole/pcontrole.php' id='login-e-cadastro-link'>Olá, " . $_SESSION['nome'] . "</a> <br><br>
						<a href='../app/logout.php' id='login-e-cadastro-link'>Sair</a>";
					}
					else
					{
