...
<head>
	...
	<meta charset="UTF-8">
	<title>Animação 3D - BNG Design</title>
...
<body>
	...
	<section id="conteudo-site">
		<section id="div">
			<div id="servico">
				<img src="imagens/figura/animacao-3d.png" alt="Logotipo" id="servico-imagem"> <br>
			...
			<!-- Inputs utilizados para funcionar o Javascript, mudando o preço conforme opção -->
					...
					<input type="hidden" name="url_foto" value="imagens/figura/animacao-3d.png">
				</form>
			</div>
	...
	<!-- ------------------------------------------------------- -->
			<div id="descricao">
				...
				<p>Você já pensou em ter o seu mascote ou assistente personalizado? Então você está no lugar certo.</p>
				<p>A característica do serviço consiste em:
				<ul id="ul-descricao">
					<li>Básico - Tudo feito em preto e branco.</li>
					<li>Básico-Intermediário - Essa opção o desenho pode ter até duas (2) cores.</li>
					<li>Intermediário - Já aqui, você pode escolher até cinco (5) cores.</li>
					<li>Avançado - Aqui você pode escolher quantas cores quiser.</li>
				</ul></p>

				<p>O tipo do serviço:
				<ul id="ul-descricao">
					<li>Rosto estático - Consiste em uma imagem do rosto humano ou animal.</li>
					<li>Rosto animado - O rosto pode ser animado com duração de até três (3) segundos</li>
					<li>Figura animada - Essa opção da direito a mais detalhes, como o corpo, por exemplo. A animação é de até cinco (5) segundos</li>
					<li>Figura personalizada com cutscene - Fique livre para animar como quiser em até quinze (15) segundos.</li>
				</ul></p>
