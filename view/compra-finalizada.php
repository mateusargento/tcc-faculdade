...
<html lang="pt-BR">
<head>
	<link rel="stylesheet" href="css/estilocomprafinalizada.css">
...
<body>
	...
	<section id="conteudo-site">
		<section id="div">
			<?php
				if($_GET['mensagem'] == "Compra efetuada com sucesso! Você pode gerar o seu boleto abaixo.")
				{
					echo "<h3 id='mensagem'>" . $_GET['mensagem'] . "</h3> <br>";
					echo "<a id='informacoes-link' href='../app/boletophp-master/bngboleto.php' id='informacoes-link' target='_blank'>Gerar boleto</a> <br><br>";
				}
				else
				{
			...
			?>
            <button name="submit" id="submit" onclick="window.location.href='minha-pagina/compras.php'">Ir para compras</button>
		</section>
	</section>
