...
<html lang="pt-BR">
<head>
	<link rel="stylesheet" href="../css/pcontrole/estilopcontrolealteracao.css">
	...
	<!-- ------------------------------------------------------- -->
		...
		-->
			<?php
				...
				$p1->codigo_profissional = $_SESSION['codigo_profissional'];
				$resultado = $p1->Listar();
			...
			// Nome e Sobrenome -->
					echo "<div id='dividir-para-dois-formularios'>
						<div id='dividir-para-dois-formularios-lado-esquerdo'>
							<input type='hidden' name='codigo_profissional' value='" . $_SESSION['codigo_profissional'] . "'>
