...
function pessoaFisica()
{
	...
	document.getElementsByTagName('div')[5].style.display = 'flex' // Nome e sobrenome
	document.getElementsByTagName('div')[14].style.display = 'flex' // CPF e RG
...
function pessoaJuridica()
{
	...
	document.getElementsByTagName('div')[8].style.display = 'flex' // Razão Social e Nome Fantasia
	document.getElementsByTagName('div')[17].style.display = 'flex' // CNPJ e Inscrição Municipal
	document.getElementsByTagName('div')[20].style.display = 'flex' // Inscrição Estadual e Isento
...
function cartaoDeCredito()
{
	// Coloca os campos necessários para o cadastro de pessoa física
	document.getElementsByTagName('div')[5].style.display = 'flex' // Nome e sobrenome
	document.getElementsByTagName('div')[8].style.display = 'flex' // CPF e RG
